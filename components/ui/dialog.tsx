...
type DialogContentProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
  /** Domyślnie true — okno wyszukiwania ukrywa przycisk X (Escape nadal zamyka). */
    ...
    >
      ...
      {showCloseButton ? (
        <DialogPrimitive.Close
          className={cn(
            "text-foreground ring-offset-background hover:bg-muted/80 dark:hover:bg-white/10 absolute top-4 right-4 rounded-md p-1 opacity-90 transition-[opacity,background-color] hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",
          )}
        >
