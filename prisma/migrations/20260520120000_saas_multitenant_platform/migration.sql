-- SaaS multi-tenant platform migration
-- Ręczne kroki enum (tylko stare środowiska): prisma/scripts/manual/saas_multitenant_step1_enums.sql
...
-- Backfill organization members from users
